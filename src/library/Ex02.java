...
//      1.
        ...
        System.out.println("1. 전체 사용자 수 : " + totalNumber.length + "명");
...
//      2.
        ...
        for (int i = 0; i < splitSemiColon.length; i++) {
            ...
            System.out.println("■ 이름 : " + splitComma[0] + " | ■ 나이 : " + splitComma[1] + " | ■ 이메일 : " + splitComma[2]);
        }

//      4.
        System.out.print("4. \"gmail.com\" 도메인 사용자 : ");
...
//      5.
        System.out.println("5. 가장 나이가 많은 사용자 : ");
        int[] ages = new int[4];
        for (int i = 0; i < splitSemiColon.length; i++) {
            String[] splitComma = splitSemiColon[i].split(",");
...
//      6.
        ...
        System.out.println("6. 이름에 \"김\"이 포함된 사용자 수 : " + kimCount + "명");
    }
}
